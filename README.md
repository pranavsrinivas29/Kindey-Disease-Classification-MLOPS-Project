...
```bash
https://github.com/pranavsrinivas29/Kindey-Disease-Classification-MLOPS-Project
```
### STEP 01- Create a conda environment after opening the repository
### any virtual env name is acceptable
```bash
...
## 3. Create ECR repo to store/save docker image
    - Save the URI: 262907162002.dkr.ecr.eu-north-1.amazonaws.com/kidney
